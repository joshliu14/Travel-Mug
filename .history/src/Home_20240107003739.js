...
class Home extends React.Component {
  ...
  render() {
    if (!isLoaded(this.props.cafes) || !isLoaded(this.props.filterOptions)) {
      return <div>Loading...</div>;
    }

    console.log(this.props.filterOptions);
    const filters = Object.values(this.props.filterOptions).map(
      (option, index) => {
        return (
...
export default compose(
  firebaseConnect(["/Cafes", "/filterOptions"]),
